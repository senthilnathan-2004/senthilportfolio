    ...
    <div className="pt-6 md:pt-8 pb-4 sm:pb-8">
      <div className="max-w-6xl mx-auto px-2 md:px-6 lg:px-8">
        ...
        <div className="mb-6 sm:mb-8 px-1 md:px-0">
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-mono font-bold text-text-primary text-justify leading-tight mt-1 mb-3 w-full">
            {project.title}
          </h1>
        ...
        {project.caseStudyRichText && (
          <div className="bg-bg-card border border-border-subtle rounded-2xl sm:rounded-3xl lg:rounded-4xl p-4 sm:p-8 lg:p-14 shadow-xl">
            <div className="mb-5 pb-3 sm:pb-4 border-b border-border-subtle">
              <h2 className="font-mono font-bold text-base sm:text-xl lg:text-2xl text-text-primary text-justify tracking-wide w-full">
