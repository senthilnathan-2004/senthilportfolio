        ...
        <div className="grid lg:grid-cols-[1fr_1.2fr] gap-8 lg:gap-10 items-stretch">
          ...
          >
            <div className="text-center md:text-left flex flex-col items-center md:items-start">
              ...
              <h2 className="text-4xl lg:text-5xl font-display text-text-primary uppercase tracking-tight mb-1 sm:mb-2 px-2 md:px-0 text-center md:text-left leading-tight sm:leading-tight">
            ...
            <div className="bg-bg-card/40 border border-border-subtle/30 rounded-xl p-3.5 sm:p-4 md:bg-transparent md:border-none md:p-0 md:rounded-none mt-1 md:mt-0 mb-4 sm:mb-10">
