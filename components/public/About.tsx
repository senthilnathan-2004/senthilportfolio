          ...
          >
            ...
            {(heroImageUrl || imageUrl) && (
              <div className="flex md:hidden justify-center mt-2 mb-8 w-full px-2">
                <div className="flex items-center justify-center gap-6 px-4 sm:px-5 py-2.5 rounded-full bg-bg-card/90 border border-green-accent/30 shadow-[0_0_20px_rgba(0,255,128,0.15)] backdrop-blur-md max-w-fit">
